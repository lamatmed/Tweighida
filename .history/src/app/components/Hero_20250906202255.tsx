...
export default function Hero() {
  ...
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center text-center bg-gradient-to-br from-[#232946] via-[#6246ea] to-blue text-white px-4 overflow-hidden">
      {/* Decorative blob */}
