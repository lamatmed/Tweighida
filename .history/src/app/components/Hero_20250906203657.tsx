...
export default function Hero() {
  ...
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center text-center bg-gradient-to-br from-[#23294] via-blue-500 to-blue-500 text-white px-4 overflow-hidden">
      {/* Decorative blob */}
