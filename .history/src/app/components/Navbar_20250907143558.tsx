    ...
    <nav className="sticky top-0 z-50 bg-white shadow-md border-b border-gray-100">
      <div className="max-w-7xl mx-auto flex justify-between items-center px-4 py-3">
        ...
        <ul className="hidden lg:flex space-x-1">
          ...
          <li>
            <a href="/products" className="px-4 py-2 rounded-lg font-medium text-gray-700 hover:text-indigo-600 hover:bg-indigo-50 transition-all flex items-center gap-2">
              <FileText size={18} /> Produits
            </a>
          </li>
          <li>
            <a href="/solutions" className="px-4 py-2 rounded-lg font-medium text-gray-700 hover:text-indigo-600 hover:bg-indigo-50 transition-all flex items-center gap-2">
              <BsRobot size={18} /> Solutions IA
            </a>
          </li>
          <li>
        ...
        {isOpen && (
          ...
          >
            <ul className="flex flex-col py-3 px-4 space-y-2">
              ...
              <li>
                <a href="/products" className="flex items-center gap-3 px-4 py-3 rounded-lg font-medium text-gray-700 hover:text-indigo-600 hover:bg-indigo-50 transition-all">
                  <FileText size={20} /> Produits
                </a>
              </li>
              <li>
                <a href="/solutions" className="flex items-center gap-3 px-4 py-3 rounded-lg font-medium text-gray-700 hover:text-indigo-600 hover:bg-indigo-50 transition-all">
                  <BsRobot size={20} /> Solutions IA
                </a>
              </li>
              <li>
