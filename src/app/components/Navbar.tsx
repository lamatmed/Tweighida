    ...
    <nav className="sticky top-0 z-50 bg-white/70 backdrop-blur-2xl border-b border-gray-200/50 shadow-sm">
      <div className="max-w-7xl mx-auto flex justify-between items-center px-6 py-4">
        <div className="flex items-center gap-3">
          ...
          >
            <div className="bg-gradient-to-tr from-indigo-600 to-purple-600 p-2.5 rounded-xl shadow-lg shadow-indigo-100 group-hover:rotate-6 transition-transform">
              <Building2 size={24} className="text-white" />
            </div>
            <span className="text-2xl font-extrabold text-slate-900 tracking-tight">Tweighida</span>
          </motion.a>
        </div>
